...
class Loja: Object {
    ...
    convenience init(_ nome: String, iconePequeno: String, iconeGrande: String, vendeComputador: Bool,  vendeJogos: Bool, favorita: Bool, produtos: List<Produto> = List<Produto>()) {
        self.init()
        self.nome = nome
